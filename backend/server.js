...
mongoose.connect(MONGO_URI)
  ...
  .catch((err) => {
    ...
    console.warn('ℹ️ Sahakaar server running in standalone mode. Frontend fallback to mock data enabled.');
  });

app.listen(PORT, () => {
  console.log(`🚀 Sahakaar Backend Server running on http://localhost:${PORT}`);
});
